...
def save_outputs(
    ...
    for ind in range(len(outputs)):
        ...
        output_item["token_probs"] = token_logprobs[ind]
        output_item["topk_probs"] = topk_logprobs[ind]
        output_item["avg_logprob"] = avg_logprobs[ind]
        output_item["avg_topk_entropy"] = avg_topk_entropies[ind]
        output_item["configs"] = {
            "engine": args.engine,
